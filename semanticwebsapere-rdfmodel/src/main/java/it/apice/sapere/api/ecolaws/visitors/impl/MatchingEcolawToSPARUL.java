 ...
 * 
 */
public final class MatchingEcolawToSPARUL implements EcolawVisitor {
	...
	// /**
	// * <p>
	// * Builds a new {@link MatchingEcolawToSPARUL}.
	// * </p>
	// *
	// * @param anEcolaw
	// * The ecolaw to be translated
	// */
	// private MatchingEcolawToSPARUL(final Ecolaw anEcolaw) {
	// if (anEcolaw == null) {
	...
	// return new MatchingEcolawToSPARUL(law).createQuery();
	// }
}
