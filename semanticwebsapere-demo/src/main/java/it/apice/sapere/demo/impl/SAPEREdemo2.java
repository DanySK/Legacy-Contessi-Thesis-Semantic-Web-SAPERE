...
import it.apice.sapere.demo.agents.impl.FOAFPersonAgent;
...
public class SAPEREdemo2 {
	...
	/**
	 * <p>
	 * Builds a new {@link SAPEREdemo2}.
	 * </p>
	 * 
	 * @param factory
	 *            {@link SAPEREAgentsFactory} instance
	 */
	public SAPEREdemo2(final SAPEREAgentsFactory factory) {
		if (factory == null) {
	...
	public void execute() throws Exception {
		...
		final Person johnPerson = new Person("john", 2.0D, 10.0D);
		...
		_fact.createAgent("john_agent", new FOAFPersonAgent(johnPerson))
				.spawn();
