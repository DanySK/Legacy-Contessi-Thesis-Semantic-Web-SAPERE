...
public abstract class AbstractTestSAPEREFactory extends AbstractModelTest {
	 ...
	 */
	protected String createValidStringValue() {
		return "";
	}
	 ...
	 */
	protected String createValidStringValue2() {
		return "literal";
	}
	 ...
	 */
	protected String createValidLanguageCode() {
		return "en";
	}
	 ...
	 */
	protected SAPEREAgentBehaviour createMockBehav() {
