...
/**
 * <p>
 * Test case for LSAParser entity.
 * </p>
 * 
...
public abstract class AbstractTestLSAParser extends AbstractModelTest {
	 ...
	 */
	protected abstract LSAParser createParser(PrivilegedLSAFactory fact);
	...
	public final void testSAPEREParser() throws Exception {
		final LSAParser parser = createParser(createPrivilegedFactory());
	...
	private InputStream getInputAsStream() throws Exception {
		return AbstractTestLSAParser.class.getClassLoader()
				.getResourceAsStream(
