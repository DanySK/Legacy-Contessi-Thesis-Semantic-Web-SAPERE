 ...
 * 
 */
public class IncreasingInjectReadUpdateRemoveAgent implements
		SAPERESysAgentSpec {
	...
	/**
	 * <p>
	 * Builds a new {@link IncreasingInjectReadUpdateRemoveAgent}.
	 * </p>
	 * 
	 * @param dataFile
	 *            Source of data
	 */
	public IncreasingInjectReadUpdateRemoveAgent(final File dataFile) {
		if (dataFile == null) {
	...
	public void behaviour(final NodeServices services, final LogUtils out,
		...
		out.log(String.format(
				"Inject-Read-Remove profiling with data from \"%s\"..", 
				source));
